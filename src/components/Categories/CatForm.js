...
export default function CatForm(props) {
    const handleSubmit = (values) => {
        ...
        if (!props.category) {
            ...
            axios.post(`http://todoapi.melissabalino.com/api/Categories`, catToCreate).then(() => {
            ...
            axios.put(`http://todoapi.melissabalino.com/api/Categories/${props.category.categoryId}`, catToEdit).then(() => {
